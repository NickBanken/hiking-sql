        ...
        <div class = "row d-flex justify-content-center">
            ...
            <div class="row">
                    ...
                    <div class="form-group m-3">
                        ...
                        <input type ="text" name="distance" value="<?php echo $dist?>" placeholder = "Distance" class="form-control">
                    </div>
                    <div class="form-group m-3">
                        <label>Duration:</label>
                        <input type ="text" name="duration" value="<?php echo $dura?>" placeholder = "Duration" class="form-control">
                    </div>
                    <div class="form-group m-3">
                        <label>Height:</label>
                        <input type ="text" name="height" value="<?php echo $heig?>" placeholder = "Height" class="form-control">
                    </div>
                    <div class="form-group m-3">
